...
test_algorithms = [
    ...
    algorithm_instances_config.algorithms_configured['IndSets strategy- dummy vector coloring-projection'],
    algorithm_instances_config.algorithms_configured['IndSets strategy- dummy vector coloring-greedy'],
