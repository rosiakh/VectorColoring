...
# graphs.append(create_k_cycle(n=50, k=5))  done
# graphs.append(create_k_cycle(n=50, k=12))  done
# graphs.append(create_k_cycle(n=50, k=20))  done
# graphs.append(create_k_cycle(n=125, k=12))  done
# graphs.append(create_k_cycle(n=125, k=30))  done
# graphs.append(create_k_cycle(n=125, k=50))  done
# graphs.append(create_k_cycle(n=250, k=24))  done
# graphs.append(create_k_cycle(n=250, k=60))  done
# graphs.append(create_k_cycle(n=250, k=100))  do later or never

# graphs.append(create_erdos_renyi_graph(n=50, p=0.1))  done
# graphs.append(create_erdos_renyi_graph(n=50, p=0.5))  done
# graphs.append(create_erdos_renyi_graph(n=50, p=0.9))  done
# graphs.append(create_erdos_renyi_graph(n=125, p=0.1))  done
# graphs.append(create_erdos_renyi_graph(n=125, p=0.5))  done
# graphs.append(create_erdos_renyi_graph(n=125, p=0.9))  done
# graphs.append(create_erdos_renyi_graph(n=250, p=0.1))  done
# graphs.append(create_erdos_renyi_graph(n=250, p=0.5))  done
# graphs.append(create_erdos_renyi_graph(n=250, p=0.9))  done

# graphs.append(create_watts_strogatz_graph(n=50, k=5, p=0.1))  done
# graphs.append(create_watts_strogatz_graph(n=50, k=25, p=0.1))  done
# graphs.append(create_watts_strogatz_graph(n=50, k=40, p=0.1))  done
# graphs.append(create_watts_strogatz_graph(n=125, k=15, p=0.1))  done
# graphs.append(create_watts_strogatz_graph(n=125, k=60, p=0.1))  done
# graphs.append(create_watts_strogatz_graph(n=125, k=100, p=0.1))  done
# graphs.append(create_watts_strogatz_graph(n=250, k=30, p=0.1))  done
# graphs.append(create_watts_strogatz_graph(n=250, k=120, p=0.1))  done
# graphs.append(create_watts_strogatz_graph(n=250, k=200, p=0.1))  done

# graphs.append(create_barabasi_albert_graph(n=50, m=5))  done
# graphs.append(create_barabasi_albert_graph(n=50, m=25))  done
# graphs.append(create_barabasi_albert_graph(n=50, m=40))  done
# graphs.append(create_barabasi_albert_graph(n=125, m=15))  done
# graphs.append(create_barabasi_albert_graph(n=125, m=60))  done
# graphs.append(create_barabasi_albert_graph(n=125, m=100))  done
# graphs.append(create_barabasi_albert_graph(n=250, m=30))  done
# graphs.append(create_barabasi_albert_graph(n=250, m=120))  done
# graphs.append(create_barabasi_albert_graph(n=250, m=200))  done
...
# graphs.append(read_graph_from_file("dimacs", "DSJC125.9", 'random', starting_index=1))  done
...
# graphs.append(read_graph_from_file("dimacs", "DSJC500.5", 'random', starting_index=1))  vertices >
# graphs.append(read_graph_from_file("dimacs", "DSJC500.9", 'random', starting_index=1))  vertices >

# Geometric random graphs

# graphs.append(read_graph_from_file("dimacs", "DSJR500.1", 'random_geometric', starting_index=1))  done
# graphs.append(read_graph_from_file("dimacs", "DSJR500.1c",'random_geometric',  starting_index=1))  vertices >
# graphs.append(read_graph_from_file("dimacs", "DSJR500.5", 'random_geometric', starting_index=1))  vertices >
...
# graphs.append(read_graph_from_file("dimacs", "flat300_20_0", 'random_flat', starting_index=1))  done
...
# graphs.append(read_graph_from_file("dimacs", "inithx.i.1",'register_allocation', starting_index=1))  vertices >
# graphs.append(read_graph_from_file("dimacs", "inithx.i.2",'register_allocation', starting_index=1))  vertices >
# graphs.append(read_graph_from_file("dimacs", "inithx.i.3",'register_allocation', starting_index=1))  vertices >
...
# graphs.append(read_graph_from_file("dimacs", "le450_15d", 'leighton_graph', starting_index=1))  done (not in thesis yet)
...
# graphs.append(read_graph_from_file("dimacs", "homer",'stanford_gb', starting_index=1))  vertices >
